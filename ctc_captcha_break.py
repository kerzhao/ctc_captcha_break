...
class NewAEASGD(AEASGD):
    ...
    def __init__(self, keras_model, worker_optimizer, loss, num_workers=2, batch_size=32,
        ...
        super(NewAEASGD, self).__init__(keras_model, worker_optimizer, loss, num_workers, 
                                        batch_size, features_col, label_col, num_epoch, 
                                        communication_window, rho, learning_rate, 
                                        master_port=5000)
...
trainer = NewAEASGD(keras_model=model, worker_optimizer=optimizer, loss=custom_loss, num_workers=num_workers, 
